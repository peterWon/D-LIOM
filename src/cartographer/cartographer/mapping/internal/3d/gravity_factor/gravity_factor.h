 ...
 */
class GravityFactor {_CARTOGRAPHER_MAPPING_INTERNAL_3D_GRAVITY_FACTOR_H_
 ...
 * @addtogroup Navigation
 */
class GTSAM_EXPORT Rot3GravityFactor: 
  public NoiseModelFactor1<Rot3>, public GravityFactor {
